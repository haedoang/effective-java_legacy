...
/**
 * packageName : item10
 * fileName : EquivalenceRelationTEst
 * author : haedoang
 * date : 2022-01-10
 * description : equals 메서드 동치 관계 테스트
 */
public class EquivalenceRelationTest {
    ...
    public void reflexivity() {
        ...
        MomsTouchBurger.Size burgerSize = MomsTouchBurger.Size.SMALL;

        // then
        assertThat(name.equals("haedong")).isTrue();
        assertThat(age.equals(34)).isTrue();
        assertThat(isMarried.equals(false)).isTrue();
        assertThat(burgerSize.equals(MomsTouchBurger.Size.LARGE));
    }
